...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            val kotlinXSerialization = version("kotlinx-serialization", "1.10.0")
            val ktor = version("ktor", "3.4.0")
            val jib = version("jib", "3.5.2")
            val logback = version("logback", "1.5.28")
            ...
            library("kotlinLogging", "io.github.oshai", "kotlin-logging-jvm").version("7.0.3")
