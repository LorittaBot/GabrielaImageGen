...
class TrumpGenerator(
    ...
    fun generate(targetImage1: BufferedImage, targetImage2: BufferedImage): ByteArray {
        val scaledImage1 = targetImage1.getScaledInstance(240, 240, BufferedImage.SCALE_SMOOTH).toBufferedImage()
        val scaledImage2 = targetImage2.getScaledInstance(240, 240, BufferedImage.SCALE_SMOOTH).toBufferedImage()
