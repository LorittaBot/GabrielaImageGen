...
sealed class CharacterPortrait(
    ...
    companion object {
        ...
        fun fromCustom(bufferedImage: BufferedImage, colorPortraitType: ColorPortraitType): CustomImageCharacterPortrait {
            ...
            val finalImage = when (colorPortraitType) {
                ColorPortraitType.COLORED -> scaledInstance
                ColorPortraitType.BLACK_AND_WHITE -> {
                    BufferedImage(
                ...
                ColorPortraitType.SHADES_OF_GRAY -> {
                    BufferedImage(
                        scaledInstance.getWidth(null),
                        scaledInstance.getHeight(null),
