    ...
    override suspend fun onRequest(call: ApplicationCall) {
        try {
            ...
            val result = withContext(m.coroutineDispatcher) {
                ...
                logger.info { "Request with UUID: $uniqueId; Use decreased frames? $useDecreasedFrames; High Quality Permits: ${highQualitySemaphore.availablePermits}; Low Quality Permits: ${lowQualitySemaphore.availablePermits}" }
